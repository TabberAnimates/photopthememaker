...
if (prompt1.toLowerCase().includes("y")) {
  ...
  let code = `["#300d20","#17060f80","#290b1b","#2e0c1e","#380f25","#42122c","ffffff","ff42a7"]˃body { background-color: #95234a; animation-name: example; animation-duration: 4s; animation-iteration-count: 1.7976931348623157e+309; } @keyframes example { 0%   {background-color: #95234a;} 25%  {background-color: #4b87bc;} 50%  {background-color: #1e183b;} 75% {background-color: #3f7ca9;} 100%   {background-color: #95234a;} }`;
  loadCode(code);
}
